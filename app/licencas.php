                    ...
                    <fieldset>
                        <div class="pure-g">
                            <div class="pure-u-1-12">
                                <input name="dataInicio" class="pure-u-23-24" type="text" value="'.$a['dataInicio']->format('Ymd').'" readonly>
                            </div>
                            <div class="pure-u-1-12">
                                <input name="dataTermino" class="pure-u-23-24" type="text" value="'.$a['dataTermino']->format('Ymd').'" readonly>
                            </div>
                            <div class="pure-u-1-12">
