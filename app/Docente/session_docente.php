...
<head>
  ...
  <?php  
    ...
    $sql  = " SELECT * FROM vInfoPessoalDocente WHERE cpf = '$login'";
    $stmt = sqlsrv_query( $conn, $sql);
    $a = sqlsrv_fetch_array($stmt);
    $_SESSION['siape'] = $a['siape'];
    if (is_null($_SESSION['siape'])) {
      unset($_SESSION['login']);
      unset($_SESSION['senha']);
      ...
      <td height="90" colspan="2" bgcolor="#CCCCCC"><h3>Painel do Aluno</h3>
        ...
        <div class="pure-menu pure-menu-horizontal">
            ...
            <ul class="pure-menu-list">
                <li class="pure-menu-item"><a href="informacaoPessoalDocente.php" class="pure-menu-link">Infomações pessoais</a></li>
